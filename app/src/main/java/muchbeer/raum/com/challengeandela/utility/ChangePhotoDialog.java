...
import muchbeer.raum.com.challengeandela.firebaseauth.OnPhotoReceivedListener;

public class ChangePhotoDialog extends DialogFragment {

    private static final String LOG_TAG = ChangePhotoDialog.class.getSimpleName();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        selectPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d(LOG_TAG, "onClick: accessing phones memory.");
        ...
        takePhoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d(LOG_TAG, "onClick: starting camera");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICKFILE_REQUEST_CODE && resultCode == Activity.RESULT_OK) {
            ...
            Log.d(LOG_TAG, "onActivityResult: image: " + selectedImageUri);
            ...
            Log.d(LOG_TAG, "onActivityResult: done taking a photo.");
    ...
    public void onAttach(Context context) {
        ...
        try{
            ...
            Log.e(LOG_TAG, "onAttach: ClassCastException", e.getCause() );
        }
